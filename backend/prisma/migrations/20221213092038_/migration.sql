...
-- AddForeignKey
ALTER TABLE "Faculty_Pref" ADD CONSTRAINT "Faculty_Pref_facultyPref_fkey" FOREIGN KEY ("facultyPref") REFERENCES "Faculty"("facultyId") ON DELETE RESTRICT ON UPDATE CASCADE;
