/*
  ...
  - A unique constraint covering the columns `[word]` on the table `Filtered_Word` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "Filtered_Word_word_key" ON "Filtered_Word"("word");
