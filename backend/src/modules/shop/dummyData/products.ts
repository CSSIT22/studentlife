...
let products: Product[] = [
    {
        ...
        categoryId: 1,
        contactId: 1,
        description: "Do enim amet mollit eiusmod esse duis voluptate Lorem. Incididunt anim ipsum sint quis culpa. Eiusmod duis aliquip voluptate sint ullamco enim magna occaecat incididunt non eu ex",
        color: "Black",
        size: "12 inch",
        stock: 50000,
        deliveryFee: 10,
    ...
    },
    {
        ...
        categoryId: 2,
        contactId: 2,
        description: "Exercitation voluptate eiusmod ex dolor sint. Exercitation sit elit incididunt eu voluptate fugiat aute veniam commodo et ad sint anim est. Nulla qui id non ullamco voluptate anim. Est reprehenderit duis consequat dolor cillum irure occaecat. Incididunt est aute esse cupidatat culpa exercitation culpa eiusmod amet dolore eu ullamco irure",
        color: "Red",
        size: "12 inch",
        stock: 5000,
        deliveryFee: 50,
    ...
    },
    {
        ...
        categoryId: 25,
        contactId: 3,
        description: "Lorem nisi aute commodo minim magna ea duis ex mollit veniam voluptate. Sit eiusmod ullamco dolore tempor. Quis quis deserunt exercitation non irure eiusmod irure minim id cupidatat aliquip laboris non. Magna amet aliqua veniam sunt consectetur sunt aliquip ea culpa Lorem anim irure",
        color: "Red",
        size: "12 inch",
        stock: 5000,
        deliveryFee: 50,
    ...
    },
    {
        ...
        categoryId: 19,
        contactId: 3,
        description: "Reprehenderit ullamco officia eiusmod officia. Sint consectetur consequat velit qui. Anim ut pariatur reprehenderit amet nostrud mollit ullamco",
        color: "Black",
        size: "12 inch",
        stock: 50000,
        deliveryFee: 10,
