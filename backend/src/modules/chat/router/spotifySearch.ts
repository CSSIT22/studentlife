...
const spotify = async (req: Request, res: Response) => {
    ...
    let Authparameters = {
        ...
        headers:{
            'Content-Type' : 'application/json',
            Authorization:"Bearer BQBjsCzKwJLfS_AFF9V8PyWcOz4s-yjrEVmyQJ928Y98_8gQlBSy0RSptWDBBGsUOIJ1kOWVFuSKPziLD_sX8kjR5fGckAPMXgKZ22fWskC_f1z_A9S2mYRJkW-LvQ-yEXJ94lflaPdsVC4Bm8OBSNwCqjNCoRh4-CywQkBXMQom",
        }
    }
