...
//Desktop Preview
                    <Box width="440px" borderRadius="md" padding={5} background=" tomato" textColor={"white"}>
                        ...
                        <Box width="400px" borderRadius="md" background="gray"  >
                            ...
                            <Box ml={2} >
                                ...
                                <HStack spacing={1} mt={1} mb={1}>
                                    <Tag background={"RGBA(0, 0, 0, 0.64)"} color={'white'} size={"sm"}>#Study</Tag>
                                    <Tag background={"RGBA(0, 0, 0, 0.64)"} color={'white'} size={"sm"}>#Learning</Tag>
                                </HStack>
                                <Text fontSize={'xs'}>
                                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Modi esse, maiores officiis tempore beatae officia vel mollitia optio alias velit! Voluptatem neque ut optio beatae fuga facere nesciunt sed at?
                                </Text>
                                <HStack color={'black'} fontWeight={'500'} padding='1'>
