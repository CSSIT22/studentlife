...
//Desktop Preview
                <Box display={{ sm: "none", md: "block" }} width="440px" borderRadius="md" padding={5} background=" tomato" textColor={"white"}>
                    <HStack justifyContent={"space-between"} align={'center'} padding={1} mt={-2}>
                        <Text fontSize={"xl"} fontWeight={700} >
