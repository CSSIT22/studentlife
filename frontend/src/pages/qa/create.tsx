...
import { CheckboxGroup, useDisclosure
        , Grid, Box, Heading, FormControl, Button, Input, InputGroup, InputLeftElement
        , Flex, Spacer, VStack
        , Popover, PopoverContent, PopoverBody, PopoverTrigger, Textarea } from "@chakra-ui/react"
        ...
        <QAnsAppBody>
            ...
            <VStack background={"white"} w={"57.5%"}>
                ...
                <Flex>
                    ...
                    <Popover>
                        <PopoverTrigger>
                            <Button colorScheme={"orange"} w={"20%"}>Add File</Button>
                        </PopoverTrigger>
                        <PopoverContent>
                            <PopoverBody>
