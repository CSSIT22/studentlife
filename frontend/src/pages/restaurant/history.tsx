        ...
        >
            ...
            <Grid templateColumns={{ base: "repeat(1, 1fr)", md: "repeat(2, 1fr)", lg: "repeat(3, 1fr)" }} gap={"6"}>
                {property.map((e1: any) => {
                    ...
                    return (
                        <GridItem>
                            <Historycontent resName={e1.restaurant.resName} date={new Date(e1.updatedAt).toLocaleString("th-TH", { timeZone: "Asia/Bangkok" })} status={e1.isLike} img={e1.restaurant.images} />
