...
<VStack spacing={4} align='stretch' marginTop={"10%"}>
    <Box h='70px' >
        ...
        <a href="./custom">
            <Center> 
                <Button colorScheme='yellow' w={'50%'} height={"60px"} >SHORTLINK CUSTOMIZE</Button> 
            </Center>
        </a>
    </Box>    
    </Box>
    ...
    <a href="./generator">
        <Center>
            <Button colorScheme='green' w={'50%'} height={"60px"}>SHORTLINK GENERATOR</Button>
            </Center>
            </a>
    </Box>
    <Box h='70px' >
    <a href="./history">
    <Center><Button colorScheme='linkedin' w={'50%'} height={"60px"}>SHORTLINK HISTORY</Button>
        </Center>
    </a>
    </Box>
</VStack>
