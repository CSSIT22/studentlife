import { Box, Button, Center, Text, useBreakpointValue } from '@chakra-ui/react'
                    ...
                    <SwiperSlide>
                        ...
                        <Center>
                            <Box>
                                ...
                                <Center>
                                    <Button className="swiper-no-swiping" colorScheme="orange" w={{ base: "179px", md: "183px" }} h={{ base: "53px", md: "61px" }} boxShadow="0px 10px 15px -3px rgba(0, 0, 0, 0.1), 0px 4px 6px -2px rgba(0, 0, 0, 0.05)" mt={{base: "45px", md: "24px"}}>
                                        <Box>
                                            <Text fontWeight="700"
                                                fontSize="14px"
                                            ...
                                            <Text fontWeight="700"
                                                fontSize="14px"
                                                lineHeight="120%"> & Finding Friend</Text>
                                        </Box>
                                    </Button>
                                </Center>
                            </Box>
