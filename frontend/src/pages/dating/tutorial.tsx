...
const Tutorial = () => {
    ...
    function handleSubmit() {
        API.post("/dating/tutorial/setDatingEnroll")
            .then(() => checkOption())
            .catch((err) => {
                toast({ status: "error", position: "top", title: "Error", description: "Please login before submitting!" }), setIsError(true)
            })
    }
        ...
        <DatingAppBody>
            <Box>
                {isSubmitted || isLoading ? (
                    <Box position="absolute" top={{ base: "180", md: "-100" }}>
                    ...
                    <Swiper id="tutorial" pagination={true} modules={[Pagination]} className="mySwiper">
                            ...
                            <Center>
                                <Box>
                                    <Text
                                        ...
                                        lineHeight="133%"
                                        color="black"
                                        pt={{ base: "39.5px", md: "53px" }}
                                    >
                                        Hello!
                                    </Text>
                                    {isMobile ? (
                                        <Text textAlign="center" fontWeight="700" fontSize="36px" lineHeight="133%" color="orange.600" pt="33px">
                                            {fName.charAt(0) + fName.substring(1).toLowerCase()}&nbsp;
                                            {lName.charAt(0) + lName.substring(1).toLowerCase()}
                                        </Text>
                                    ) : (
                                        <>
                                            <Text
                                            ...
                                            <Text textAlign="center" fontWeight="700" fontSize="30px" lineHeight="133%" color="orange.600">
                                                {lName.charAt(0) + lName.substring(1).toLowerCase()}
                                            </Text>
                                        </>
                                    )}
                                    {isMobile ? (
                                        <>
                                            <Text textAlign="center" fontWeight="700" fontSize="36px" lineHeight="133%" color="black" pt="33px">
                                                Welcome to
                                            </Text>
                                            <Text textAlign="center" fontWeight="700" fontSize="36px" lineHeight="133%" color="black">
                                                Dating & Finding Friend
                                            </Text>
                                        </>
                                    ) : (
                                        <>
                                            <Text textAlign="center" fontWeight="700" fontSize="30px" lineHeight="133%" color="black" pt="39.5px">
                                                Welcome to
                                            </Text>
                                            <Text textAlign="center" fontWeight="700" fontSize="30px" lineHeight="133%" color="black">
                                                Dating
                                            </Text>
                                            <Text textAlign="center" fontWeight="700" fontSize="30px" lineHeight="133%" color="black">
                                                &
                                    ...
                                    <Box display="flex" justifyContent="center" pt={{ base: "32px", md: "80px" }} pb="178px">
                                        <FirstPageNextButton>
                                            <Text fontWeight="700" fontSize={{ base: "20px", md: "25px" }} lineHeight="120%" color="white">
                                                Next
                                            </Text>
                                        </FirstPageNextButton>
                                    </Box>
                        ...
                        <SwiperSlide>
                            {isMobile ? (
                                <>
                                    <Box position="absolute" top={220} left={0}>
                                        <LeftButton>
                                            <BsArrowLeft color="white" fontSize="50px" />
                                        </LeftButton>
                                    </Box>
                                    <Box position="absolute" top={220} right={0}>
                                        <RightButton>
                                            <BsArrowRight color="white" fontSize="50px" />
                                        </RightButton>
                                    </Box>
                                </>
                            ) : (
                                    ...
                                    <Box>
                                        ...
                                        <Center>
                                            <Button
                                                ...
                                                className="swiper-no-swiping"
                                                colorScheme="orange"
                                                w={{ base: "179px", md: "183px" }}
                                                h={{ base: "53px", md: "61px" }}
                                                boxShadow="0px 10px 15px -3px rgba(0, 0, 0, 0.1), 0px 4px 6px -2px rgba(0, 0, 0, 0.05)"
                                                mt={{ base: "45px", md: "24px" }}
                                            >
                                                <Box>
                                                    <Text fontWeight="700" fontSize="14px" lineHeight="120%">
                                                        Start using Dating
                                                    </Text>
                                                    <Text fontWeight="700" fontSize="14px" lineHeight="120%">
                                                        & Finding Friend
