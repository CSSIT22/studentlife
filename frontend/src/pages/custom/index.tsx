  ...
  return (
    <AppBody>
      <Center> <Box width={"80%"} height={"300px"} background={"#D9D9D9"} borderRadius="20px" marginTop={"10%"}>
        <Box>
          <Heading width={"300px"} height={"50px"} marginLeft={"10%"} marginTop={"-5"} background={"#f2f2f2"} borderRadius={"10px"} fontSize={"xl"} border={"3px solid white"} textAlign={"center"}>SHORTLINK CUSTOMIZE</Heading>
        </Box>
      ...
      <Center> <Box width={"80%"} height={"200px"} background={"#D9D9D9"} borderRadius="20px" marginTop={"1%"}>
        <VStack spacing={4} align='stretch' marginTop={"5%"}>
          <Box h='70px' >
            <AlertDialog
              isOpen={isOpen}
