                        ...
                        <Center>
                            <Box w="90%" p={4} color="white" alignItems={"center"}>
                                ...
                                <HStack spacing="24px">
                                    ...
                                    <Box w="400px" h="10">
                                        <Heading color={"black"}>
                                            <Text fontSize="2xl">Kitibhum Supanurat</Text>
                                        </Heading>
                                    </Box>
                                    <Box w="180px" h="10" marginTop={"30px"} borderColor={"black"}>
                                ...
                                <HStack spacing="24px" marginTop={"5%"}>
                                    ...
                                    <Box w="400px" h="10">
                                        <Heading color={"black"}>
                                            <Text fontSize="2xl">Ratchanon Kondee</Text>
                                        </Heading>
                                    </Box>
                                    <Box w="180px" h="10" marginTop={"30px"}>
                                        <Checkbox defaultChecked></Checkbox>
                                    </Box>
                                </HStack>
                                <hr></hr>
                                <HStack spacing="24px" marginTop={"5%"}>
                                    ...
                                    <Box w="400px" h="10">
                                        <Heading color={"black"}>
                                            <Text fontSize="2xl">Passapol PK</Text>
                                        </Heading>
                                    </Box>
                                    <Box w="180px" h="10" marginTop={"30px"}>
                                        <Checkbox defaultChecked></Checkbox>
                                ...
                                <HStack spacing="24px" marginTop={"5%"}>
                                    ...
                                    <Box w="400px" h="10">
                                        <Heading color={"black"}>
                                            <Text fontSize="2xl">Nattapat Medtoe</Text>
                                        </Heading>
                                    </Box>
                                    <Box w="180px" h="10" marginTop={"30px"}>
                                        <Checkbox defaultChecked></Checkbox>
