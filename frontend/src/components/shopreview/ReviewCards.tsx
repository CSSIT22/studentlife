...
const ReviewCards: FC<{ image: []; name: String; ment: String; date: String; amo_rate: String; amo_like: String; reviewId: String; }> = ({ image, name, ment, date, amo_rate, amo_like, reviewId }) => {
    //console.log(image)
    return (
