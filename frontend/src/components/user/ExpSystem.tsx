...
function ExpSystem() {
    return (
        <div>
            <Flex rounded="xl" direction="column" mt={4} ml="5" bg="orange.400" position="initial">
                <Text color="white" p="5" fontSize="xl" fontWeight="500">
                    LV.10
                </Text>
                <div></div>
                <Progress rounded="xl" mx="3" position="initial" colorScheme="green" color="gray.400" size="md" value={52} />
