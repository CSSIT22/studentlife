                ...
                <Flex gap={2} mt={3}>
                    <Link to={disableBtn ? "" : `/groups/id/${communityID}/`} relative="path">
                        <Button
                            ...
                            size={"sm"}
                            isActive={activeBtn == 1 && !isPrivate ? true : false}
                            disabled={isPrivate}
                        >
                            Discussion
                        </Button>
                    </Link>
                    <Link to={disableBtn ? "" : `/groups/id/${communityID}/member`} relative="path">
                        <Button
                            backgroundColor={"white"}
                            _hover={{ background: "default" }}
                            size={"sm"}
                            isActive={activeBtn == 2 && !isPrivate ? true : false}
                            disabled={isPrivate}
                        >
                            Member
                        </Button>
                    </Link>
                    <Link to={disableBtn ? "" : `/groups/id/${communityID}/file`} relative="path">
                        <Button
                            backgroundColor={"white"}
                            _hover={{ background: "default" }}
                            size={"sm"}
                            isActive={activeBtn == 3 && !isPrivate ? true : false}
                            disabled={isPrivate}
                        >
                            File
                        </Button>
