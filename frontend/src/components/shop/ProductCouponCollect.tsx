...
const PoductCouponCollect: propsType = ({ couponCode, discountAmount, minSpend, details, validUntil, productId, image }) => {
    ...
    function collectCoupon (){
        API.post("/shop/postUserCoupon", {couponCode: couponCode}).then((res) => toast({
            title: 'Coupon Code Collected!',
            status: 'success',
            isClosable: true,
            duration: 900,
        })).catch((err) => toast({
            title: 'Coupon code already collected! An error has occured please try again later!',
            status: 'error',
            isClosable: true,
            duration: 1800,
        }))
            ...
            <Box sx={styles.productBox}>
                <Flex direction="column">
                    ...
                    <Box px="6" pt="1">
                        ...
                        <Center mt="3">
                            <VStack>
                            <Button bg="orange.400" color="white" onClick={collectCoupon}>Collect</Button>
                            </VStack>
                        </Center>
...
export default PoductCouponCollect